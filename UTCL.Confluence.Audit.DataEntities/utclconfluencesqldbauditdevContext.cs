...
namespace UTCL.Confluence.Audit.DataEntities
{
    public partial class utclconfluencesqldbauditdevContext : DbContext
    {
        ...
        public virtual DbSet<_5sauditorReviewDetails> _5sauditorReviewDetails { get; set; }
...
//            }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AuditScheduleData>(entity =>
            {
                ...
                entity.Property(e => e.AuditFrequency).HasMaxLength(255);
                ...
                entity.Property(e => e.AuditorFor).HasMaxLength(255);
            ...
            modelBuilder.Entity<_5sauditorReviewDetails>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("5SAuditorReviewDetails");

                entity.Property(e => e.AssessmentQuestion)
                    .HasColumnName("Assessment Question")
                    .HasColumnType("ntext");
                ...
                entity.Property(e => e.ObtainedScore).HasColumnName("Obtained Score");
